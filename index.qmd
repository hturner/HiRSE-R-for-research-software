...
subtitle: HiRSE Summer of Programming Languages <br> July 2025
...
::: {.fragment}
> R has a simple goal: To turn ideas into software, quickly and faithfully 
...
::: {.notes}
skip image 21 as can test groupSort interactively in console
:::
...
![](demo32.png){.fragment height=520px}

![](demo33.png){.fragment height=520px}
:::
...
or more work (self-hosted ShinyProxy).
...
Within the package source directory run `use_rcpp("Manhattan")`
